...
if __name__ == "__main__":
    video_path = "C:/Users/hancomtst/Desktop/Nvidiaproject/video/aespa_forever.mp4"  # Update this path
    output_path = "./output_aespa_forever.mp4"  # Update this path if needed
